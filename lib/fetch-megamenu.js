...
for (const section of sectionsUrls) {
  ...
  data = data.replace(/font-family: 'Glyphicons Halflings';/gi, '')

  // Correction du code
  data = data.replace(/&times/gi, '&times;')

  // Remplacement des URLs relatives en absolues vers https://bib.umontreal.ca
  data = data.replace(/href="\//gi, 'href="https://bib.umontreal.ca/')
